...
import backend.dl_src.fr_utils as fr_utils
...
def faceRecoModel(input_shape):
    """
    Implementation of the Inception fd_models used for FaceNet
    
    Arguments:
    input_shape -- shape of the images_v01 of the dataset

    Returns:
    fd_models -- a Model() instance in Keras
    """
